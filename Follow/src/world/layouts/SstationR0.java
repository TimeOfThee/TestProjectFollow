...
public class SstationR0 extends Layout{
	
	int clor=0;
	boolean tog=true;
	
	public SstationR0(Handler handler) {
	...
	public void enterFrom(int dir) {//updoleri
		...
		case 2://le
			...
			break;
		case 3://ri
			spawnPlayer(width-1-handler.getPlayer().getWidth(),handler.getPlayer().getY()+ (600-380)-(800-20) );
			break;
		default:
